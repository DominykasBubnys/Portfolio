        ...
        <div className={classes.modal_container}>
          ...
          <div className={classes.modal_content}>
            ...
            <div className={classes.modal_logo_container}>
              <img className={classes.modal_logo} src="/assets/git_logo.png" alt=''/>
              <a target="_blank" rel="noopener noreferrer" href={item.githubUrl}>Github repo</a>
            </div>

            <div className={classes.modal_logo_container}>
              <img className={classes.modal_logo} src="/assets/preview.jpg" alt=''/>
              <a target="_blank" rel="noopener noreferrer" href={item.LiveUrl}>Live demo</a>
            </div>

            <div className={classes.modal_tech}>
              <ul>
                {item.stack.map((element, i) => <li key={i}>{element}</li>)}
              </ul>
            </div>
